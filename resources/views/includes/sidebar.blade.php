        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">Daftar Pesanan</li><!-- /.menu-title -->
                    <li class="">
                    <a href="{{ route('transactions.index') }}"> <i class="menu-icon fa fa-list"></i>Lihat Daftar Pesanan</a>
                    </li>
                    <li class="">
                        <a href="{{ route('transactions.create') }}"> <i class="menu-icon fa fa-plus"></i>Tambah Pesanan</a>
                    </li>
